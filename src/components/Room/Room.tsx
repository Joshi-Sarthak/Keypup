	...
	return (
		<div className="w-full flex flex-row justify-center items-center">
			<div className="flex flex-col w-1/3 items-center h-96 mr-8">
				...
				<div className="w-2/3 text-stone-500 dark:text-neutral-400 font-thin tracking-wider px-4 py-3 border border-gray-300 dark:border-neutral-700 rounded-2xl focus:outline-none focus:ring-2 focus:ring-stone-500 bg-transparent text-center mt-8">
			...
			<div className="flex flex-col w-1/3 items-center h-96">
				...
				/>
				<button className="font-medium text-stone-500 w-1/4 mt-8 py-2 rounded-2xl flex justify-center items-center tracking-wide bg-transparent hover:dark:border-stone-400 border dark:border-stone-800 border-neutral-100 hover:border-stone-600 hover:text-stone-600 dark:text-neutral-500 hover:dark:text-neutral-100 transition-all duration-400">
					Join room
				</button>
			</div>
		</div>
