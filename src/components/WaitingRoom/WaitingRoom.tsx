		...
		<div className="flex flex-col justify-center items-center px-4">
		  ...
		  {useMultiplayerstore.getState().isHost && (
			<button
			  ...
			  className="relative inline-flex border border-neutral-500 dark:border-stone-900 items-center justify-center px-6 md:px-8 py-2.5 overflow-hidden tracking-tighter mt-12 md:mt-16 text-white bg-neutral-400 dark:bg-stone-800 rounded-full group"
			>
			  ...
			  <span className="relative text-sm md:text-base font-semibold uppercase tracking-widest dark:text-neutral-400 text-stone-600 group-hover:text-neutral-300 transition-all duration-200">
				Start Game!
			  </span>
			</button>
		  )}
